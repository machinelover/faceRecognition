# -*- coding: utf-8 -*-
"""
Created on Sun Mar 18 22:37:00 2018
...
#my_faces_path = 'D:/BaiduYunDownload/Machine Learning/Python27/faceRecognition/my_faces'
size = 64
#N=len(os.listdir(my_faces_path))#有几类（即几个人）
#imgs = []
#labs = []
##np_img = []
##np_lab = []
...
#
#def readData(path , h=size, w=size):#读取数据
#    i=0
...
#
## 随机划分测试集与训练集
#train_x, test_x, train_y, test_y = train_test_split(imgs, labs, test_size=0.15,
...
def cnnlayer():
    ...
    Wout = weight_variable([1024, 5])
    bout = weight_variable([5])
...
#
#        summary_writer = tf.summary.FileWriter('D:/BaiduYunDownload/Machine Learning/Python27/faceRecognition/tmp', graph=tf.get_default_graph())
#
#        for n in range(100):
...
#                    # 准确率大于0.98时保存并退出
#                    if acc > 0.995 :
#                        saver.save(sess, 'D:/BaiduYunDownload/Machine Learning/Python27/faceRecognition/train_faces.model')
#                        sys.exit(0)
#        saver.save(sess, 'D:/BaiduYunDownload/Machine Learning/Python27/faceRecognition/train_faces.model')
#        print('保存成功')
#
